            ...
            >
              {filtered.map((project, i) => {
                ...
                return (
                  ...
                  >
                    <TiltCard intensity={6} lift={12} className="h-full">
                      <CardTag
                        {...linkProps}
                        className="surface-card group flex h-full cursor-pointer flex-col overflow-hidden bg-white !transform-none"
                      >
                        <ImageReveal
                          direction="up"
                          delay={i * 0.04}
                        ...
                        >
                          ...
                          {project.type || project.category ? (
                            <span
                              className="absolute left-3 top-3 rounded-md border border-white/20 bg-dark/70 px-2 py-1 font-mono text-[10px] uppercase tracking-[0.08em] text-white backdrop-blur-sm"
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <p className="font-display text-lg font-semibold tracking-tight text-foreground transition duration-200 group-hover:text-primary">
                                {project.title}
                              </p>
                            ...
                            <span className="mt-1 inline-flex size-8 shrink-0 items-center justify-center rounded-full border border-border bg-background text-primary transition duration-200 group-hover:border-primary group-hover:bg-primary group-hover:text-white group-hover:rotate-12">
