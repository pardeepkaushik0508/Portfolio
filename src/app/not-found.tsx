...
export default function NotFound() {
  return (
    <main
      id="main"
      className="relative flex min-h-[78vh] items-center justify-center overflow-hidden border-b border-border bg-[linear-gradient(165deg,#0c1210_0%,#15201c_55%,#1a2822_100%)]"
    >
      <div
      ...
      />
      <div className="container-shell relative mx-auto flex w-full flex-col items-center px-4 py-28 text-center sm:py-32">
